...
public class SongsRecyclerViewAdapter extends RecyclerView.Adapter<SongsRecyclerViewAdapter.mySongsViewHolder> {
    ...
    public SongsRecyclerViewAdapter(Context mContext, List<SongModel> mData, int type) {
    ...
    public void onBindViewHolder(@NonNull mySongsViewHolder mySongsViewHolder, int i) {
        ...
        if (this.typeSong == 0) {
            ...
            if (mData.get(i).getSongArtPath().equals("Un Known"))
...
//    public List<SongModel> getmData() {
//        return mData;
//    }
...
//        private ImageView cp_iv_AlbumArt;
        ...
        public mySongsViewHolder(View itemView, final OnItemClickListener clickListener) {
            ...
            tv_Name = itemView.findViewById(R.id.song_name);
            tv_Artist = itemView.findViewById(R.id.song_artist);
